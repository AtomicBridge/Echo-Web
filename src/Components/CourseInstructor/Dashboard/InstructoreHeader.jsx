  ...
  return (
    ...
    />
            ...
            <li className="nav-item">
                    {userlogged=== 'instructor'?<Link  className="nav-link active" aria-current="page" to='/instructorhome'>Home</Link>:<Link  className="nav-link active" aria-current="page" to='/trainerhome'>Home</Link>}
                </li>
                <li className="nav-item">
                    {userlogged=== 'instructor'?<Link className="nav-link" to='/instructorprogresstracking'>Progress Tracking</Link>:<Link className="nav-link" to='/trainerprogresstracking'>Progress Tracking</Link>}
                </li>
                <li className="nav-item">
                    <Link className="nav-link" to='/instructorsettings' >Settings</Link>
                </li>
                <li className="nav-item">
    ...
    <div className="dropdown-toggle" href="#" id="Dropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul className="dropdown-menu" aria-labelledby="Dropdown">
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-united-kingdom-48.png" alt=""  />English <i className="fa fa-check text-success ms-2"></i></a>
        </li>
        <li><hr className="dropdown-divider" /></li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-poland-48.png" alt=""  />Polski</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-china-48.png" alt=""  />中文</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-japan-48.png" alt=""  />日本語</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-germany-48.png" alt=""  />Deutsch</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-france-48.png" alt=""  />Français</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-spain-48.png" alt=""  />Español</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-russia-48.png" alt=""  />Русский</a>
        </li>
        <li>
            <a className="dropdown-item" href="#"><img className='flag' src="./img/courseinstructor/home/flags/icons8-portugal-48.png" alt=""  />Português</a>
        </li>
    </ul>
</div>
                </li>
