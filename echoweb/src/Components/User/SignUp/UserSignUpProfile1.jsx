...
const UserSignUpProfile1 = () => {
  ...
  return (
    ...
    <div className="text-center mb-2 mt-md-3 position-relative">
                                <img src={avatar || "./img/user/signup/image 6 (1).png"} alt="avatar" className="rounded-circle img-fluid" width="140" style={{ width: '140px', height: '140px' }} />
                            ...
                            <div className="form-group mb-3 mt-1">
                                ...
                                <input type="text" className="form-control rounded-4 py-2 px-2 border-0" id="fullName" placeholder="Full Name" style={{ backgroundColor: '#FAFAFA', height: '52px' }} value={fullName} onChange={(e) => setFullName(e.target.value)} />
                            </div>
                            <div className="form-group mb-3 mt-3">
                                <label className="form-label fw-bold" htmlFor="location">Location</label>
                                <div className="position-relative">
                                    <input type="text" className="form-control rounded-4 py-2 px-2 border-0" id="location" placeholder="Location" style={{ backgroundColor: '#FAFAFA', height: '52px' }} value={location} onChange={(e) => setLocation(e.target.value)} />
                            ...
                            <div className="form-group mb-3 mt-3">
                                ...
                                <textarea className="form-control rounded-4 py-3 px-2" id="description" placeholder="Description" rows="7" style={{ backgroundColor: '#FAFAFA' }} value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
                            </div>
                            <div className="text-center mb-3">
                                <button className="btn rounded-pill px-5 py-3 shadow w-100" onClick={handleContinue} style={{ backgroundColor: '#1D191C', color: 'white' }} disabled={!fullName || !location || !description || !avatar}>Continue</button>
                            </div>
    </form>
</div>
