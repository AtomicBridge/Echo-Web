                        ...
                        <div className="position-relative">
                          <div className="custom-dropdown">
                            <div className=" rounded-4 py-3 px-2 border-0"  style={{ backgroundColor: '#FAFAFA', height: '52px' }}>
                              {selectedInterest ? selectedInterest : 'Dropdown to select'}
                              <span className="position-absolute top-50 end-0 translate-middle-y pe-3 dropdown-label" onClick={toggleDropdown}>
    ...
    <div className="row">
      <div className="col-12">
        <label className="d-flex justify-content-between align-items-center border-bottom">
          ...
          <input type="radio" name="interest" value="UI/UX Designer" checked={selectedInterest === "UI/UX Designer"} style={{accentColor:'#1D191C' ,width: '20px', height: '20px', marginRight: '8px' }} onChange={() => handleInterestChange("UI/UX Designer")} />
      ...
      <div className="col-12">
        <label className="d-flex justify-content-between align-items-center border-bottom">
          ...
          <input type="radio" name="interest" value="Graphic Designer" checked={selectedInterest === "Graphic Designer"}style={{accentColor:'#1D191C' ,width: '20px', height: '20px', marginRight: '8px' }} onChange={() => handleInterestChange("Graphic Designer")} />
        </label>
      </div>
      <div className="col-12">
        <label className="d-flex justify-content-between align-items-center border-bottom">
          <span>Web Designing</span>
          <input type="radio" name="interest" value="Web Designing" checked={selectedInterest === "Web Designing"}style={{accentColor:'#1D191C' ,width: '20px', height: '20px', marginRight: '8px' }} onChange={() => handleInterestChange("Web Designing")} />
        </label>
      </div>
      <div className="col-12">
        <label className="d-flex justify-content-between align-items-center border-bottom">
          <span>Web Development</span>
          <input type="radio" name="interest" value="Web Development" checked={selectedInterest === "Web Development"}style={{accentColor:'#1D191C' ,width: '20px', height: '20px', marginRight: '8px' }} onChange={() => handleInterestChange("Web Development")} />
        </label>
      </div>
      <div className="col-12">
        <label className="d-flex justify-content-between align-items-center">
          <span>Illustrator</span>
          <input type="radio" name="interest" value="Illustrator" checked={selectedInterest === "Illustrator"}style={{accentColor:'#1D191C' ,width: '20px', height: '20px', marginRight: '8px' }} onChange={() => handleInterestChange("Illustrator")} />
        </label>
      </div>
    </div>
  </div>
    ...
    <div className="row">
      ...
      <div className="col-md-6">
        <div className="form-group mb-3">
          <label className="form-label fw-bold" htmlFor="form2Example18">Your Weight</label>
          <div className="col-md-12">
            <div className="d-flex align-items-center">
              ...
              <div className="btn-group col-md-3 mx-3">
                <button type="button" className="btn dropdown-toggle rounded-4 border-0" data-bs-toggle="dropdown" aria-expanded="false" style={{ backgroundColor: '#FAFAFA', height: '52px' }}>
                  {selectedweight}
                </button>
      ...
      <div className="col-md-6">
        <div className="form-group mb-3">
          <label className="form-label fw-bold" htmlFor="form2Example18">Your Height</label>
          <div className="col-md-12">
            <div className="d-flex align-items-center">
              <div className="position-relative col-md-7">
                        ...
                        <div className="text-center align-items-center">
                          <div className=" mt-4 mx-auto">
                            <button
                              ...
                              onClick={(e) => { e.preventDefault(); handleAccountSuccessful(); }}
                              style={{ backgroundColor: '#1D191C', color: 'white' }}
                            >
                              Continue
                            </button>
                          </div>
