                ...
                <div className="w-100">
                  ...
                  <div className="d-flex flex-column align-items-center align-items-sm-start h-custom-2 px-xl-5 ms-xl-4  pt-xl-0 mt-xl-n5">
                    <form style={{ maxWidth: '100%', width: '100%' }}>
                      ...
                      <p className='text-secondary eighteenfont'>Elevate your ECHO account with this App.</p>
                      ...
                      <div className="form-outline mb-2">
                      <label className="form-label fw-bold" htmlFor="form2Example18">Re-Enter Password</label>
                        <div className="position-relative d-flex align-items-center">
                          <input
                      ...
                      <p>Already have an account? <Link to='/login' className="text-default"><b>Login</b></Link></p>
...
<div className='mt-3 mt-xxl-4  mx-auto'>
    <button className='btn rounded-pill px-5 py-3 shadow w-100' onClick={handlesignup}  style={{backgroundColor:'#1D191C', color:'white'}} >Sign Up</button>
</div>
                      </div>
                      </div>
