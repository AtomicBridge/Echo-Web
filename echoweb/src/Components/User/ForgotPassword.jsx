...
const ForgotPassword = () => {
                  ...
                  <div className="w-100">
                    ...
                    <div className="d-flex flex-column align-items-center align-items-sm-start h-custom-2 px-xl-5 ms-xl-4 " style={{marginTop:'25%'}}>
                      <form style={{ maxWidth: '100%', width: '100%' }}>
                        ...
                        <p className='text-secondary eighteenfont'>Please enter the email associated with your this app account. We’ll send you an OTP code to reset your password.</p>
  ...
  <div className='mb-3 mt-5  mx-auto'>
      <button className='btn rounded-pill px-5 py-3 shadow w-100' onClick={handlecontinue} style={{backgroundColor:'#1D191C', color:'white'}} >Continue</button>
  </div>
                        </div>
                        </div>
