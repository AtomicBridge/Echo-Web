                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 col-6">
                            <h4 className="banner-text"style={{fontSize: "1.6vw", fontWeight: "400"}}>The Future is Now</h4>
                            ...
                            <a href="#" className="btn btn-light mt-md-3 rounded-pill px-1 px-md-4 py-md-2 py-1 mb-5" style={{fontSize:'1vw'}}>Explore Now</a>
                        </div>
                    </div>
                </div>
            </div>
